...
class TestFrameApi:
    ...
    def test_get_frames_returns_frame_list(
        self, httpx_mock: HTTPXMock, mock_frame: dict
    ) -> None:
    ...
    def test_get_frame_by_id(self, httpx_mock: HTTPXMock, mock_frame: dict) -> None:
